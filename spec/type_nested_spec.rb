...
describe CouchbaseOrm::Types::Nested do
  it 'is able to store and retrieve a nested object' do
  ...
  it 'is able to store and retrieve an array of nested objects' do
    obj = TypeNestedTest.new
  ...
  describe 'Validations' do
    ...
    it 'does not regenerate the id after reloading parent' do
    ...
    it 'does not override the param id' do
    ...
    it 'validates the nested objects in an array' do
      obj = WithValidationParent.new
    ...
    it 'validates the nested in the nested object' do
      obj = WithValidationParent.new
      obj.child = SubWithValidation.new name: 'foo', label: 'parent'
      obj.child.child = SubWithValidation.new label: 'child'

      expect(obj).not_to be_valid
      expect(obj.child).not_to be_valid
      expect(obj.child.child).not_to be_valid
