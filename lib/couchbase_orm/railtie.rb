  ...
  module Couchbase # :nodoc:
    class Railtie < Rails::Railtie # :nodoc:
      ...
      initializer 'couchbase.load_http_errors' do |_app|
        config.after_initialize do
          ActionDispatch::ShowExceptions.rescue_responses.update(Railtie.rescue_responses) unless config.action_dispatch.rescue_responses
        end
      end
